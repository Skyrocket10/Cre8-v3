...
seven things; six are now closed — twelve properties the style vocabulary did
not have, and a setting that turns the whole library right to left without a
line of it changing — see "What the stress template found" in
