...
| `inspector` | Does an inspector edit reach the element it was showing rather than the one selected next, and does inline text survive a click elsewhere. Every check involves two elements, because one cannot see this class of bug |
