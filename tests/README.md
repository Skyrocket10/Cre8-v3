...
| `components` | Two instances of one component saying different things — same class, same computed styles, canvas and file agreeing, and a property somebody can actually set |
