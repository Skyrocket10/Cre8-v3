...
| `menus` | Right-click: does the menu open where the pointer is, stay on screen, keep a multi-selection, close without selecting what it closed over — and does Duplicate from the menu do exactly what ⌘D does, down to the undo step |
